...
function showStim(numOrient, cyclesPerSecond, spatFreq, gabor, ...
...
if isempty(currentPath)
    % Choose a Default save Path (could change this to throw error)
	currentPath='/Users/Tom/Desktop/Testing Visual Stim/';
end
...
if isempty(gaussTrim)
    % By default we set the trimming at 0.05
	gaussTrim=0.05;
end
